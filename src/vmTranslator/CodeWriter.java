...
public class CodeWriter {
    ...
    public CodeWriter(String fileName) throws IOException {
        ...
        String hackFilepath = "Output\\" + fileName + "\\asm\\" + fileName + ".asm";
        System.out.println("Creating file: " + hackFilepath);
        File hackFile = new File(hackFilepath);
        System.out.println("Writing to: " + hackFilepath);
        codeWriter = new FileWriter(hackFile);
        // Reset jump targets
        jumpTarget = 0;
        returnTarget = 0;
